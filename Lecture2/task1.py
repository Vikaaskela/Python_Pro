#Task 1
#Ресторан надає можливість зробити онлайн замовлення страв. Розмір знижки по замовленню залежить 
#від карти лояльності, яку має клієнт: Regular, Silver або Gold.
